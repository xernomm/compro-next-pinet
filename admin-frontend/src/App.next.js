    ...
    <AuthProvider>
      <BrowserRouter basename={basename}>
        ...
        <Routes>
          ...
          />
          <Route
            path="/dashboard/careers/:id/edit"
            element={
              <ProtectedRoute>
                <DashboardLayout>
                  <CareerForm />
